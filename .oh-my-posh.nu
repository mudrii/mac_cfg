# Oh-My-Posh Nushell Integration
# Regenerate with: oh-my-posh init nu --config ~/.config/oh-my-posh/gruvbox.omp.json --print | save -f ~/.oh-my-posh.nu
...
# Utility function to check oh-my-posh version
def check_omp_version [] {
    print $"Oh My Posh version: (^/opt/homebrew/bin/oh-my-posh --version | str trim)"
}
